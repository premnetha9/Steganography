...
def steg(main_image_path, hidden_image_path):
    '''
    ...
    bits
    '''
    if hidden_image_path[-4:] == '.txt':
        text.encrypt(main_image_path, hidden_image_path)
    else:
        image.merge(main_image_path, hidden_image_path)
