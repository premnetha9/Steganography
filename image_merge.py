...
def integer_to_binary(rgb):
    ...
    INPUT: An integer tuple (e.g. (195, 255, 96))
    OUTPUT: A string tuple (e.g. ("11000011", "11111111", "00010110"))
    '''
    r, g, b = rgb
...
def binary_to_integer(rgb):
    ...
    INPUT: A string tuple (e.g. ("11000011", "11111111", "00010110"))
    OUTPUT: Return an int tuple (e.g. (195, 255, 96))
    '''
    r, g, b = rgb
    return (int(r, 2),
            int(g, 2),
